...
$featurearray = array("Family and close friends mostly" => array("live in the same city","do not live in the same city"),"Family and close friends mostly " => array("share similar political opinions","share different political opinions","do not discuss politics "),"Potential risk " => array("Curfew imposed ","Organizers detained","Violent protest expected","Police presence expected","Violent police response expected","Legal repercussions expected","Counter-protest expected","COVID-19 exposure ","Protest permit denied"),"Expected turnout" => array("500 people","2500 people","10,000 people"),"Source of information" => array("Friend","Family member","Civil society organization","News/media outlet","Social media platform"));
